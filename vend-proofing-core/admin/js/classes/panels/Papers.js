...
classes.panels.Papers = function () {
	...
	function createClick () {
		Dialog.create({
			size: "500x*",
			title: Lang.lookup("Create Paper"),
			content: classes.dialogs.PaperEditor,
			init: {
			},
			owner: this,
			options: [{
	...
	function draw () {
		...
		var xhtml = '';
			...
			xhtml += 			'<div class="Button Create"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> ' + Lang.lookup("Create New Paper") + '</div>';
...
classes.panels.Papers.prototype = new EventDispatcher();

...
classes.components.formobjects.Email = function () {
	...
	function render () {
		...
		var xhtml = '';
			...
			xhtml += 	'<input class="Label Left" placeholder="' + Lang.lookup("your_email_address") + '" type="text" value="' + _ingest._attributes.href + '" />';
			xhtml += 	'<input class="Label Right" placeholder="' + Lang.lookup("your_name") + '" type="text" value="' + _ingest._value + '" />';
...
classes.components.formobjects.Email.prototype = new EventDispatcher();

...
classes.dialogs.ProductEditor = function () {
	...
	function render () {
		...
		var xhtml = '';
			...
			xhtml += 		'<label>' + Lang.lookup("Product Editor Title") + '</label>';
			...
			xhtml += 				'<label>' + Lang.lookup("Product Editor Price") + '</label>';
			xhtml += 				'<input type="number" max="999999" min="0" step=".0001" value="' + _price + '" />';
			xhtml += 			'</div>';
			xhtml += 		'</div>';
			xhtml += 		'<div class="Col">';
			xhtml += 			'<div class="Group Input Shipping">';
			xhtml += 				'<label>' + Lang.lookup("Product Editor Shipping") + '</label>';
			...
			xhtml += 		'<label>' + Lang.lookup("Product Editor Description") + '</label>';
